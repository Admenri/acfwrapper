...
//
// $hash=e93ea9dfb477151705055980cf10272ec105dde6$
//

#ifndef ACF_CTOCPP_FILE_DIALOG_CALLBACK_CTOCPP_H_
#define ACF_CTOCPP_FILE_DIALOG_CALLBACK_CTOCPP_H_
#pragma once
...
class AcfFileDialogCallbackCToCpp
    : public AcfCToCppRefCounted<AcfFileDialogCallbackCToCpp,
                                 AcfFileDialogCallback,
                                 acf_file_dialog_callback_t> {
 public:
  AcfFileDialogCallbackCToCpp();
  virtual ~AcfFileDialogCallbackCToCpp();

  // AcfFileDialogCallback methods.
  void Continue(bool use_default,
                const std::vector<AcfString>& file_paths,
                const AcfString& base_path) override;
  void Cancel() override;
};

#endif  // ACF_CTOCPP_FILE_DIALOG_CALLBACK_CTOCPP_H_
