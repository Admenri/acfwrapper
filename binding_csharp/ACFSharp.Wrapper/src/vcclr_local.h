//
//  vcclr_local.h - modified version of vcclr.h from c:\Program Files
//  (x86)\Microsoft Visual Studio 11.0\VC\include\vcclr.h. Modifications
//  indicated below.
//
...
// Deliberately disabled, since this causes mscorlib.dll to be referenced twice
// from two different locations, breaking IntelliSense whenever this header file
// is included.
// #using <mscorlib.dll>
#include <gcroot.h>
